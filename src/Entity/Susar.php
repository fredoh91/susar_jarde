...
#[ORM\Table(name: 'susar')]
#[ORM\Index(name: 'statusdate_idx', columns: ['statusdate'])]
#[ORM\Index(name: 'dateEvaluation_idx', columns: ['dateEvaluation'])]
#[ORM\Index(name: 'dateAiguillage_idx', columns: ['dateAiguillage'])]
class Susar
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
